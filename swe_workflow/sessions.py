...
async def list_threads_command(
    ...
    """CLI handler for: swe-workflow threads list."""
    ...
    if not threads:
        ...
        console.print("[dim]Start a conversation with: swe-workflow[/dim]")
        return
...
async def delete_thread_command(thread_id: str) -> None:
    """CLI handler for: swe-workflow threads delete."""
