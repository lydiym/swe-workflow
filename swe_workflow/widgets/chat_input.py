"""Chat input widget for swe-workflow with autocomplete and history support."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            history_file: Path to history file (default: ~/.swe-workflow/history.jsonl)
        ...
        if history_file is None:
            history_file = Path.home() / ".swe-workflow" / "history.jsonl"
