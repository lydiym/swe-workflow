...
It wraps the prebuilt middleware functionality from swe-workflow.middleware.skills and adapts
it for direct filesystem access needed by CLI commands.

For middleware usage within agents, use swe-workflow.middleware.skills.SkillsMiddleware directly.
"""
