...
from swe_workflow.image_utils import (
    ImageData,
    create_multimodal_content,
    encode_image_to_base64,
    get_clipboard_image,
)
from swe_workflow.input import ImageTracker
...
class TestGetClipboardImage:
    ...
    @patch("swe_workflow.image_utils.sys.platform", "linux")
    ...
    @patch("swe_workflow.image_utils.sys.platform", "darwin")
    @patch("swe_workflow.image_utils._get_macos_clipboard_image")
    ...
    @patch("swe_workflow.image_utils.sys.platform", "darwin")
    @patch("swe_workflow.image_utils.subprocess.run")
    ...
    @patch("swe_workflow.image_utils.sys.platform", "darwin")
    @patch("swe_workflow.image_utils._get_clipboard_via_osascript")
    @patch("swe_workflow.image_utils.subprocess.run")
