"""End-to-end unit tests with fake LLM models."""
...
from swe_workflow.agent import create_cli_agent
...
def mock_settings(tmp_path: Path, assistant_id: str = "test-agent") -> Generator[Path, None, None]:
    ...
    # Patch settings
    with patch("swe_workflow.agent.settings") as mock_settings_obj:
        mock_settings_obj.user_swe_workflow_dir = tmp_path / "agents"
...
class TestSWEWorkflowEndToEnd:
    """Test suite for end-to-end functionality with fake LLM."""
